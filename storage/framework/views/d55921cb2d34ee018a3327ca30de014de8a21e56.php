   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			<?php endif; ?>
            <div class="col-lg-12">
			 <?php echo Form::open(array('route' => 'product.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation')); ?>
                ...
                <div class="form-actions">
                    ...
                    <a href="<?php echo e(url('product')); ?>"  class="btn btn-default">Cancel</a>
                </div>
			<?php echo Form::close(); ?>
